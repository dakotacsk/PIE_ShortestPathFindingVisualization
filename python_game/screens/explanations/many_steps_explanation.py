...
class ManyStepsExplanation(ScrollingTextDisplay):
    def __init__(self, screen, retry_callback):
        explanation_text = [
            ...
            "- Suboptimal reward design, making the agent fail to differentiate",
            "  between paths leading to the goal and other routes.",
            "- Sparse rewards where the agent struggles to associate actions",
            "  with progress towards the goal.",
            "- Highly dynamic or complex environments where the agent's policy",
            ...
            "",
            "Understanding these challenges can help improve the agent's",
